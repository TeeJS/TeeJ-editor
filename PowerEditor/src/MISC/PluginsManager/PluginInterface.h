...
// You should implement (or define an empty function body) those functions which are called by TeeJ-editor plugin manager
...
// This API return always true now, since TeeJ-editor isn't compiled in ANSI mode anymore
