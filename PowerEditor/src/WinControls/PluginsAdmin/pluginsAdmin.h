...
struct PluginUpdateInfo
{
	...
	Version _version;
	// Optional
	std::pair<Version, Version> _nppCompatibleVersions; // compatible to TeeJ-editor interval versions: <from, to> example:
	                                                    // <0.0.0.0, 0.0.0.0>: plugin is compatible to all TeeJ-editor versions (due to invalid format set)
	...
	std::pair<std::pair<Version, Version>, std::pair<Version, Version>> _oldVersionCompatibility; // Used only by Plugin Manager to filter plugins while loading plugins
	                                                                                              ...
	                                                                                              // The 2nd interval versions are for TeeJ-editor versions
