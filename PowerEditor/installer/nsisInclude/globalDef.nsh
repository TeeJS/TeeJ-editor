...
!define APPNAME "TeeJ-editor"

; ------------------------------------------------------------------------
; Get version from the TeeJ-editor binary

!ifdef ARCH64
	!getdllversion "..\bin64\TeeJ-editor.exe" nppVer_
!else ifdef ARCHARM64
	!getdllversion "..\binarm64\TeeJ-editor.exe" nppVer_
!else
	!getdllversion "..\bin\TeeJ-editor.exe" nppVer_
!endif
...
!define CompanyName		"TeeJ"
!define Description		"TeeJ-editor : a locked-down (offline) build of Notepad++"
!define Version		"${nppVer_1}.${nppVer_2}.${nppVer_3}.${nppVer_4}"
!define ProdVer		"${VERSION_MAJOR}.${VERSION_MINOR}"
!define LegalCopyright		"Based on Notepad++ (GPL). Copyleft 1998-2026 by Don HO"
